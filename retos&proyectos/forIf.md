...
A continuación la plantilla que se ha de utilizar para desarrollar el reto. Para resolverlo correctamente lo único que se puede editar para conseguir los patrones solicitados es lo se encuentra entre los comentarios.
